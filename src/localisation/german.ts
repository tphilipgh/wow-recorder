...
const GERMAN: Translations = {
  ...
  [Phrase.ChallengeModeDescription]: 'Ob Herausforderungsmodi aufgenommen werden sollen.',
  ...
  [Phrase.CloudUploadRetailDescription]: 'Wenn Retail in die Cloud hochgeladen werden sollen.',
  [Phrase.CloudUploadClassicDescription]: 'Wenn Classic in die Cloud hochgeladen werden sollen.',
  ...
  [Phrase.AudioTracksLabel]: 'Spuren',
  ...
  [Phrase.TagDialogText]: 'Diese Beschreibung ist in der Suchleiste durchsuchbar.',
  ...
  [Phrase.ForceSdrDescription]: "Erzwingt, dass das Video in SDR anstatt HDR gerendert wird.",
  ...
  [Phrase.ManualRecordDescription]: 'Aktiviert manuelle Aufnahme, die ein Benutzer nach Bedarf starten und stoppen kann, um Dinge aufzunehmen, die nicht vom Kampflog erfasst werden.',
  [Phrase.ManualRecordHotKeyDescription]: 'Setze einen Hotkey, um die Aufnahme manuell zu starten und zu stoppen.',
  [Phrase.ManualRecordUploadDescription]: 'Automatisches Hochladen von manuell gestarteten Aufnahmen in die Cloud.',
  [Phrase.ManualRecordSoundAlertLabel]: 'Ton-Alarm',
  [Phrase.ManualRecordSoundAlertDescription]: 'Spiele einen Ton-Alarm ab, wenn die manuelle Aufnahme startet oder stoppt.',
  [Phrase.StatusTitleRec]: 'Recorder',
  [Phrase.StatusTitlePro]: 'Pro',
  [Phrase.StatusTitleConnected]: 'Verbunden',
  [Phrase.StatusDescrConnected]: 'Gildenverbindung hergestellt. Pro-Features sind aktiviert.',
  ...
  [Phrase.EncodedWith]: 'Codiert mit',
  ...
  [Phrase.KillVideoSingleAudioTrackLabel]: 'Audio eines einzelnen Spielers',
  [Phrase.KillVideoSingleAudioTrackTooltip]: 'Alle Audiospuren eines einzelnen Spielers für das gesamte Video verwenden. Deaktiviert lassen, um das Audio zusammen mit dem Video zu wechseln.',
  [Phrase.KillVideoAudioTrackLabel]: 'Audioquelle',
  [Phrase.KillVideoAudioTrackTooltip]: 'Den Spieler auswählen, dessen Audiospuren verwendet werden sollen.',
