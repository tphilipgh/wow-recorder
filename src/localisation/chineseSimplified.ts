...
const CHINESE_SIMPLIFIED: Translations = {
  ...
  [Phrase.ManualRecordDescription]: '启用手动录制，用户可以按需开始和停止录制那些战斗日志无法捕获的内容。',
  ...
  [Phrase.ManualRecordSoundAlertDescription]: '当手动录制开始或停止时播放声音提醒。',
  ...
  [Phrase.KillVideoSingleAudioTrackLabel]: '单一玩家音频',
  [Phrase.KillVideoSingleAudioTrackTooltip]: '整段视频使用一名玩家的所有音轨。禁用时，音频将随视频视角切换。',
  [Phrase.KillVideoAudioTrackLabel]: '音频来源玩家',
  [Phrase.KillVideoAudioTrackTooltip]: '选择要使用其音轨的玩家。',
